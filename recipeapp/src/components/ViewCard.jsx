...
const removeRecipe = async(id)=>{
  ...
  return (
    <>
      <div class="card mb-3 shadow ms-2" style={{backgroundColor:"black",color:"white",height:"370px"}} >
    <div class="row g-0">
      <div class="col-md-4">
        <img width={'350px'} height={'362px'} src={displayRecipe.url} class="p-2" alt="..."/>
      </div>
      <div class="col-md-8">
        <div class="card-body">
          <div className='body'
          >
            <h4 class="  card-title fw-bolder" style={{color:"orange"}}>{displayRecipe.caption}</h4>
            <h5>How to Cook :</h5>
