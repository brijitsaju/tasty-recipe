    ...
    <>
      <div style={{ position: "relative" }}>
        <div className='col-6' style={{ position: "absolute", textAlign: "center", margin: "40px" }}>
          <h1 className='head'>The Tasty Palette</h1>
          ...
          <Link to={'/home'}><Button style={{ backgroundColor: "orange", color: "black" }} className='btn btn-outline rounded'>Get Started<i class="fa-solid fs-1x fa-arrow-right fa-beat ms-1"></i></Button></Link>
        </div>
        <img className='image' width={'100%'} height={'650px'} src="https://t4.ftcdn.net/jpg/02/43/11/95/360_F_243119507_sFqCazZfPjdC0EgHLJZ7ByUUJLDmweLf.jpg" alt="" />

      </div>
      <div className="flex row d-flex ps-5 mt-3">
        <div className="col-6">
          <div className=''>
            <h1 className='' style={{ fontWeight: "bolder", fontSize: "60px" ,color:"black"}}>ABOUT</h1>
            <p className='text-dark' style={{color:"black"}}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit doloribus, ipsam delectus hic corrupti nulla cum quidem ducimus! Perspiciatis dicta amet eaque sapiente sed corporis delectus velit sequi repellat cupiditate.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit doloribus, ipsam delectus hic corrupti nulla cum quidem ducimus! Perspiciatis dicta amet eaque sapiente sed corporis delectus velit sequi repellat cupiditate.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit doloribus, ipsam delectus hic corrupti nulla cum quidem ducimus! Perspiciatis dicta amet eaque sapiente sed corporis delectus velit sequi repellat cupiditate.</p>  <br />
        ...
        <div className="col-6 mt-5">
          <img className='mt-4' width={'90%'} height={'60%'} src="https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8Zm9vZHxlbnwwfHwwfHx8MA%3D%3D" alt="" />
        </div>
      </div>

      <div className='d-flex' style={{ marginTop: "-170px", backgroundColor: "black", paddingTop: "20px", paddingBottom: "20px" }}>
